...
def options(user_three):
    ...
    while True:
        ...
        if option_choice == 1:
            ...
            if option_choice == 1 and user_two != None:
                print(user_two_bank.show_info())
                if option_choice == 1 and user_three != None:
                    print(user_three_bank.show_info())
        elif option_choice == 2:
            print(user_one_bank.withdraw())
            if option_choice == 2 and user_two != None:
                print(user_two_bank.withdraw())
...
while True:
    ...
    if new_user.lower() == 'yes':
        ...
        name = input("Please enter your name: ")
        age = int(input("Please enter your age: "))
        user_three = User(name, age)
        print("Thank you for registering 3 people. Please create your bank accounts.")
        user_one_balance = bank_creation()
        user_two_balance = bank_creation()
        user_three_balance = bank_creation()
        ...
        user_three_bank = Bank(user_three.name, user_three.age, user_three_balance)
